goog.provide("chem.view.DoubleBondDrawing");
 ...
 */
chem.view.DoubleBondDrawing = function( x0, y0, x1, y1) {
	chem.view.BondDrawing.call(this,  x0, y0, x1, y1);
};
goog.inherits(chem.view.DoubleBondDrawing, chem.view.BondDrawing);

/**
 * render this drawing and all its children
 */
chem.view.DoubleBondDrawing.prototype.render = function(){
	...
	chem.view.DoubleBondDrawing.superClass_.render.call(this);
}