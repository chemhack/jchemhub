...
goog.exportSymbol('jchemhub.controller.ToolbarFactory.makeButton', jchemhub.controller.ToolbarFactory.makeButton);
...
jchemhub.controller.ToolbarFactory.addFonts = function(button, fonts) {
	goog.array.forEach(fonts, function(font) {
		jchemhub.controller.ToolbarFactory.addFont(button, font.caption,
				font.value);
	});
};
...
jchemhub.controller.ToolbarFactory.addFontSizes = function(button, sizes) {
	goog.array.forEach(sizes, function(size) {
		jchemhub.controller.ToolbarFactory.addFontSize(button, size.caption,
				size.value);
	});
};
 ...
 */
jchemhub.controller.ToolbarFactory.addFontSize = function(button, caption,
		value) {
	// Construct the option, and add it to the button.
	var option = new goog.ui.Option(caption, value, button.dom_);
	...
	content.style.fontSize = jchemhub.controller.ToolbarFactory
 ...
 * @private
 */
jchemhub.controller.ToolbarFactory.LEGACY_SIZE_TO_PX_MAP_ = [ 10, 10, 13, 16,
		18, 24, 32, 48 ];
...
jchemhub.controller.ToolbarFactory.addFormatOptions = function(button, formats) {
	goog.array.forEach(formats, function(format) {
		jchemhub.controller.ToolbarFactory.addFormatOption(button,
 ...
 */
jchemhub.controller.ToolbarFactory.addFormatOption = function(button, caption,
		tag) {
	// Construct the option, and add it to the button.
...
jchemhub.controller.ToolbarFactory.makeButton = function(id, tooltip, caption,
	...
	var button = new goog.ui.ToolbarButton(jchemhub.controller.ToolbarFactory
 ...
 */
jchemhub.controller.ToolbarFactory.makeToggleButton = function(id, tooltip,
 ...
 */
jchemhub.controller.ToolbarFactory.makeMenuButton = function(id, tooltip,
		caption, opt_classNames, opt_renderer, opt_domHelper) {
	var button = new goog.ui.ToolbarMenuButton(
			jchemhub.controller.ToolbarFactory.createContent_(caption,
 ...
 */
jchemhub.controller.ToolbarFactory.makeSelectButton = function(id, tooltip,
		caption, opt_classNames, opt_renderer, opt_domHelper) {
 ...
 * @private
 */
jchemhub.controller.ToolbarFactory.createContent_ = function(caption,
