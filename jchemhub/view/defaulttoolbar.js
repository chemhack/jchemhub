...
jchemhub.view.DefaultToolbar.MSG_FONT_NORMAL_SERIF =
 ...
 * If jchemhub.view.DefaultToolbar.setLocale was called to specify a locale
...
jchemhub.view.DefaultToolbar.addDefaultFonts = function(button) {
  ...
  var locale =
      jchemhub.view.DefaultToolbar.locale_.replace(/_/, '-').toLowerCase();
...
jchemhub.view.DefaultToolbar.FONT_SIZES_ = [
  {caption: jchemhub.view.DefaultToolbar.MSG_FONT_SIZE_SMALL, value: 1},
  {caption: jchemhub.view.DefaultToolbar.MSG_FONT_SIZE_NORMAL, value: 2},
  {caption: jchemhub.view.DefaultToolbar.MSG_FONT_SIZE_LARGE, value: 4},
  {caption: jchemhub.view.DefaultToolbar.MSG_FONT_SIZE_HUGE, value: 6}
];
...
jchemhub.view.DefaultToolbar.MSG_FORMAT_MINOR_HEADING =
...
jchemhub.view.DefaultToolbar.makeToolbar = function(items, elem,
  ...
  for (var i = 0, button; button = items[i]; i++) {
    if (goog.isString(button)) {
      button = jchemhub.view.DefaultToolbar.makeBuiltInToolbarButton(button,
          domHelper);
    }
    if (button) {
 ...
 */
jchemhub.view.DefaultToolbar.DEFAULT_BUTTONS = [
  jchemhub.view.Command.IMAGE,
  jchemhub.view.Command.LINK,
  jchemhub.view.Command.BOLD,
...
jchemhub.view.DefaultToolbar.DEFAULT_BUTTONS_RTL = [
  ...
  jchemhub.view.Command.JUSTIFY_CENTER,
  jchemhub.view.Command.JUSTIFY_LEFT,
  jchemhub.view.Command.DIR_RTL,
  jchemhub.view.Command.DIR_LTR,
  jchemhub.view.Command.EDIT_HTML
];
 ...
 * @param {string} id Button ID; must equal a {@link jchemhub.view.Command} for
 ...
 * @private
 */
jchemhub.view.DefaultToolbar.rtlButtonFactory_ = function(id, tooltip,
...
jchemhub.view.DefaultToolbar.undoRedoButtonFactory_ = function(id, tooltip,
    caption, opt_classNames, opt_renderer, opt_domHelper) {
  var button = jchemhub.view.ToolbarFactory.makeButton(id, tooltip,
      caption, opt_classNames, opt_renderer, opt_domHelper);
  button.updateFromValue = function(value) {
 ...
 * @private
 */
jchemhub.view.DefaultToolbar.fontFaceFactory_ = function(id, tooltip,
    caption, opt_classNames, opt_renderer, opt_domHelper) {
  ...
  button.updateFromValue = function(value) {
    ...
    if (value && value.length > 0) {
      item = /** @type {goog.ui.MenuItem} */ (button.getMenu().getChild(
          jchemhub.view.ToolbarFactory.getPrimaryFont(value)));
    }
 ...
 * @private
 */
jchemhub.view.DefaultToolbar.fontSizeFactory_ = function(id, tooltip,
    caption, opt_classNames, opt_renderer, opt_domHelper) {
  var button = jchemhub.view.ToolbarFactory.makeSelectButton(id, tooltip,
      caption, opt_classNames, opt_renderer, opt_domHelper);
  ...
  button.updateFromValue = function(value) {
    ...
    if (goog.isString(value) &&
      ...
      value = jchemhub.view.ToolbarFactory.getLegacySizeFromPx(
          parseInt(value, 10));
    }
 ...
 * @private
 */
jchemhub.view.DefaultToolbar.fontColorFactory_ = function(id, tooltip,
    caption, opt_classNames, opt_renderer, opt_domHelper) {
...
jchemhub.view.DefaultToolbar.backgroundColorFactory_ = function(id, tooltip,
    caption, opt_classNames, opt_renderer, opt_domHelper) {
  var button = jchemhub.view.ToolbarFactory.makeColorMenuButton(id,
...
jchemhub.view.DefaultToolbar.MSG_BACKGROUND_COLOR_TITLE =
    goog.getMsg('Text background color');

/** @desc Link button tooltip. */
jchemhub.view.DefaultToolbar.MSG_LINK_TITLE =
    goog.getMsg('Add or remove link');

/** @desc Numbered list button tooltip. */
jchemhub.view.DefaultToolbar.MSG_ORDERED_LIST_TITLE =
    goog.getMsg('Numbered list');

/** @desc Bullet list button tooltip. */
jchemhub.view.DefaultToolbar.MSG_UNORDERED_LIST_TITLE =
    goog.getMsg('Bullet list');

/** @desc Outdent button tooltip. */
jchemhub.view.DefaultToolbar.MSG_OUTDENT_TITLE =
...
jchemhub.view.DefaultToolbar.MSG_ALIGN_CENTER_TITLE =
    goog.getMsg('Align center');

/** @desc Align right button tooltip. */
jchemhub.view.DefaultToolbar.MSG_ALIGN_RIGHT_TITLE =
...
jchemhub.view.DefaultToolbar.MSG_REMOVE_FORMAT_TITLE =
...
jchemhub.view.DefaultToolbar.MSG_STRIKE_THROUGH_TITLE =
...
jchemhub.view.DefaultToolbar.MSG_EDIT_HTML_TITLE =
 ...
 *       {@link jchemhub.view.DefaultToolbar.makeToggleButton},
 ...
 *   queryable:?boolean}}
 */
jchemhub.view.ReactionEditor.ButtonDescriptor = goog.typedef;
...
// jchemhub.view.DefaultToolbar.BUTTONS_.
for (var i = 0, button;
    button = jchemhub.view.DefaultToolbar.BUTTONS_[i]; i++) {
